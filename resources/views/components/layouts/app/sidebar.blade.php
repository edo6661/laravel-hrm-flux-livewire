        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                ...
                <flux:navlist.group :heading="__('Employees')" class="grid">
                    <flux:navlist.item icon="user" :href="route('employees.index')" :current="request()->routeIs('employees.index')" wire:navigate>{{ __('List Of Employees') }}</flux:navlist.item>
                ...
                <flux:navlist.group :heading="__('Contracts')" class="grid">
                    <flux:navlist.item icon="document-text" :href="route('contracts.index')" :current="request()->routeIs('contracts.index')" wire:navigate>{{ __('List Of Contracts') }}</flux:navlist.item>
            ...
            @if(session()->has('error')) 
                <x-auth-session-status class="text-red-500" :status="session('error')" />
            @endif
